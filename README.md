...
El directori 📂 `app`conté el fitxers del servidor web `Deno`. Aquest directori 🖐 NO s'ha de modificar.
...
El directorio 📂 `app` contiene los archivos del servidor web `Deno`. Este directorio 🖐 NO debe modificarse.
